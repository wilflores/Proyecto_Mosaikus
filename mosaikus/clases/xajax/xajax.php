...
class xajax
{
	...
	function getJavascriptConfig()
	{
		...
		$html .= "\n   var xajaxRequestUri=\"".$this->sRequestURI."\";";
		$html .= "\n   var xajaxDebug=".($this->bDebug?"true":"false").";";
		$html .= "\n   var xajaxStatusMessages=".($this->bStatusMessages?"true":"false").";";
		$html .= "\n   var xajaxWaitCursor=".($this->bWaitCursor?"true":"false").";";
		$html .= "\n   var xajaxDefinedGet=".XAJAX_GET.";";
		$html .= "\n   var xajaxDefinedPost=".XAJAX_POST.";";
		$html .= "\n   var xajaxLoaded=false;";

		foreach($this->aFunctions as $sFunction => $bExists) {
			$html .= "\n   ".$this->_wrap($sFunction,$this->aFunctionRequestTypes[$sFunction]);
		}
	...
	{
		if ($sJsFile == NULL) $sJsFile = "xajax/xajax.js";
			
		if ($sJsURI != "" && substr($sJsURI, -1) != "/") $sJsURI .= "/";
		
		$html = "\n  <script type=\"text/javascript\" src=\"" . $sJsURI . $sJsFile . "\"></script>";
		if ($this->iTimeout != 0)
		{
			$html .= "\n  <script type=\"text/javascript\">";
