...
-->
    ...
    <div class="form-group">
        <div class="col-md-9">
            <label for="vigencia" class="col-md-10 control-label" style="text-align: left;">Accesos&nbsp;a&nbsp;Perfiles&nbsp;Especialista</label>
        ...
        <div class="col-md-15">
            <label for="vigencia" class="col-md-10 control-label" style="text-align: left;">Accesos&nbsp;a&nbsp;Perfiles&nbsp;Portal</label>
