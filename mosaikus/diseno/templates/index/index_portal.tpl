    ...
    <div class=" header-wrap">
      <header class=" header">
        ...
        <div class="status-bar">
            ...
            <div class="mode-toggle dropdown"  style="padding-right: 10px;">
                <a title="Modo Portal" class="active dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">
...
<script src="../../juziel/dist/js/ui.js"></script>-->
        ...
        <script type="text/javascript">
            $(document).ready(function(){
                {SCRIPT_LOAD}
                ClickOpcionesMosaikus(14, 'Maestro de Documentos','informes.png');                   
