...
<div class="form-group">
                                        <label for="accion" class="col-md-2 control-label">{N_ACCION}</label>
                                        <div class="col-md-2">                                          
                                          <textarea class="form-control" rows="3" id="accion" name="accion" data-validation="required" placeholder="{N_ACCION}">{ACCION}</textarea>
                                      </div>                                
                                  </div>
<div class="form-group">
                                        <label for="fecha_acordada" class="col-md-2 control-label">{N_FECHA_ACORDADA}</label>
                                        <div class="col-md-2">
                                          <input type="text" class="form-control" value="{FECHA_ACORDADA}" id="fecha_acordada" name="fecha_acordada" placeholder="dd/mm/yyyy"  data-validation="required"/>
                                      </div>                                
                                  </div>
<div class="form-group">
                                        <label for="fecha_realizada" class="col-md-2 control-label">{N_FECHA_REALIZADA}</label>
                                        <div class="col-md-2">
                                          <input type="text" class="form-control" value="{FECHA_REALIZADA}" id="fecha_realizada" name="fecha_realizada" placeholder="dd/mm/yyyy"  data-validation="required"/>
                                      </div>                                
                                  </div>
<div class="form-group">
                                        <label for="id_responsable" class="col-md-2 control-label">{N_ID_RESPONSABLE}</label>
                                        <div class="col-md-2">
...
<div class="form-group">
                                        <label for="id_ac" class="col-md-2 control-label">{N_ID_AC}</label>
                                        <div class="col-md-2">
                                          <input type="text" class="form-control" value="{ID_AC}" id="id_ac" name="id_ac" placeholder="{N_ID_AC}"  data-validation="required"/>
                                      </div>                                
                                  </div>
<div class="form-group">
                                        <label for="id_correcion" class="col-md-2 control-label">{N_ID_CORRECION}</label>
                                        <div class="col-md-2">
