...
-->
    <div class="form-group">
        ...
        <div class="col-md-10">
            ...
            <label for="vigencia" class="col-md-10 control-label" style="text-align: left;">Accesos&nbsp;a&nbsp;Menu</label>
            <input type="hidden" value="{NODOS}" name="nodos" id="nodos"/>
            <iframe id="iframearbol" src="pages/perfiles_portal/prueba_menuV1.php?cod_perfil={COD_PERFIL}" frameborder="0" width="100%" height="310px" scrolling="no"></iframe>
        </div>        
    </div>
