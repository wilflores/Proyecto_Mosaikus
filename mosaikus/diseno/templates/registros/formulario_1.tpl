            ...
            <form id="r-idFormulario" class="form-horizontal form-horizontal-red" role="form">
                ...
                <div class="col-xs-24">
                            <div class="form-group" id="r-tabla_fileUpload"  style="{CSS_TABLA_FILEUPLOAD}">
                                    ...
                                    <div class="col-md-10">
                                        <input type="file" value="{ARCHIVO}" id="r-fileUpload2" name="fileUpload2" onchange="cargar_archivo_reg();" data-validation="required"/>
                                        ...
                                        <div id="r-estado" style="display:none;"><img src="{PAHT_TO_IMG}loading3.gif">Cargando</div>
                                        <input type="hidden" class="form-control" value="{CODIGO_DOC}" id="r-Codigo_doc" name="Codigo_doc" placeholder="{N_CODIGO_DOC}" data-validation="required"/>
                                        <input type="hidden" class="form-control" value="{NOMBRE_DOC}" id="r-nombre_doc" name="nombre_doc" placeholder="{N_NOMBRE_DOC}" data-validation="required"/>
                                  </div>     
                             ...
                             <div class="form-group" id="r-info_archivo_adjunto"  style="display:none;">
                                    ...
                                    <div class="col-md-10">
                                        <p class="form-control-static">
                                            ...
                                            <input type="text" class="form-control" style="width: 250px;display: inline;" id="r-info_nombre" readonly="readonly">
