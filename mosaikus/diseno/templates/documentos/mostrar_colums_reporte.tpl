<!--<div class="form-group">
      ...
      <div class="checkbox">
        <label>
          <input type="checkbox" name="SelectAcc" id="SelectAcc" value="1" class="checkbox-mos-col" checked="checked"> &nbsp;
        </label>
      </div>-->
...
<div class="checkbox">
                                      <label >
                                          <input type="checkbox" name="SelectAcc" id="SelectAcc" value="7" class="checkbox-mos-col" >   &nbsp;
                                      Visor de Google</label>
                                  
                            </div>
                            <div class="checkbox">
                                      <label >
                                          <input type="checkbox" name="SelectAcc" id="SelectAcc" value="8" class="checkbox-mos-col">   &nbsp;
                            ...
                            <div class="checkbox">
                                      <label >
                                          <input type="checkbox" name="SelectAcc" id="SelectAcc" value="9" class="checkbox-mos-col" >   &nbsp;
                                      {N_ELABORO}</label>
                                  ...
                                  <div class="checkbox">
                                    ...
                                    <label >
                                          <input type="checkbox" name="SelectAcc" id="SelectAcc" value="12" class="checkbox-mos-col" >   &nbsp;
                                      {N_FORMULARIO}</label>
