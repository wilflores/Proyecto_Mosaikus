...
//                $tipo = $tipo == '' ? 'xls' : $tipo;
            ...
            default:  //echo $type;
                ...
                $funcion = "El archivo tiene un formato no permitido para el documento, solo se permiten PDF.";
    ...
    $funcion = "El tamaño del archivo $nombre excede el tamaño permitido en este sitio, Tamaño máximo del archivo a subir: 3MB";
