...
//                        $funcion = '- Documento no contiene formato apropiado: <br /> Código-Nombre archivo.Extension';
//                        $exito = 0;
...
//                        break;
                    ...
                    ELSE{
                        ...
                        if ($nombre_doc == ''){
                            ...
                            /*VALIDACION DE QUE CONTENFGA EL NOMBRE*/
    ...
    //                    }
                        if ($_POST[codigo_doc] != $codigo_doc){
                            $nombre_doc = $codigo_doc.'-'.$nombre_doc;
    ...
    //                    }
                    ...
                    $nombre_doc = substr($nombre_doc, 0, strripos ($nombre_doc, '.'));
