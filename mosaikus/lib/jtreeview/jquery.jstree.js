	...
	$.jstree.plugin("checkbox", {
		__init : function () {
			...
			this.get_container()
				...
				//alert("get_container");
					document.formulario.realiza_pregunta.value="NO";
				...
				.delegate( (this.data.ui && this.data.checkbox.noui ? "a" : "ins.jstree-checkbox") , "click.jstree", $.proxy(function (e) {
					document.formulario.realiza_pregunta.value="SI";
						//alert("delegate");
						e.preventDefault();
						//alert("111");
		...
		_fn : {
			...
			change_state : function (obj, state) {
				//alert("change_state");
				obj = this._get_node(obj);
				//alert("change_state111");
				var coll = false, rc = this._get_settings().checkbox.real_checkboxes;
				//alert("change_state2222");
				if(!obj || obj === -1) { return false; }
				//alert("change_state3333");
				state = (state === false || state === true) ? state : obj.hasClass("jstree-checked");
				//alert("change_state444");
				if(this._get_settings().checkbox.two_state) {
					...
					if(state) {
						...
						coll = obj.find("li.jstree-closed").addBack();
						...
						//alert("else_state")
						//coll = obj.find("li").addBack();
						if (document.formulario.realiza_pregunta.value=="SI") {
							//alert("SI");
							if (obj.find('li').length>0) {
								//alert("Mayor que CERO");
								coll = obj.find("li").addBack();
								var respuesta = confirm("Presione el boton ACEPTAR, si aplica a los subniveles.");
								//coll.removeClass("jstree-unchecked jstree-undetermined").addClass("jstree-unchecked");
								if (respuesta)
									coll = obj.find("li").addBack();
								else
									coll = obj.find("li.jstree-closed").addBack();
							...
							if (obj.find('li').length>0)
								//ES UN NODO PADRE, SOLO SELECCIONAMOS A EL Y NO A SUS HIJOS
								coll = obj.find("li.jstree-closed").addBack();
							else
								//EN ESTE CASO ES UN NODO HIJO, APLICA SOLO EL....
								coll = obj.find("li").addBack();
						}
