    ...
    function nuevo_Notificaciones(){
            array = new XArray();
            array.setObjeto('Notificaciones','crear');
    ...
    function validar(doc){        
        if($('#idFormulario').isValid()) {
            ...
            if (doc.getElementById("opc").value == "new")
                array.setObjeto('Notificaciones','guardar');
            else
                array.setObjeto('Notificaciones','actualizar');
    ...
    function editarNotificaciones(id){
        array = new XArray();
        array.setObjeto('Notificaciones','editar');
    ...
    function eliminarNotificaciones(id){
        if(confirm("¿Desea Eliminar el Notificaciones Seleccionado?")){
            array = new XArray();
            array.setObjeto('Notificaciones','eliminar');
            array.addParametro('id',id);
            array.addParametro('permiso',document.getElementById('permiso_modulo').value);
            array.addParametro('import','clases.notificaciones.Notificaciones');
            xajax_Loading(array.getArray());
