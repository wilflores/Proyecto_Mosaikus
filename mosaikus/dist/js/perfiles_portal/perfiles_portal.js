    ...
    function nuevo_Perfiles(){
            array = new XArray();
            array.setObjeto('Perfiles_portal','crear');
            array.addParametro('import','clases.perfiles_portal.Perfiles_portal');
            xajax_Loading(array.getArray());
    }

    function configurarPerfiles(id){      
        array = new XArray();
        array.setObjeto('Perfiles_portal','configurar');
    ...
    function validar(doc){    
        ...
        if($('#idFormulario').isValid()) {
            ...
            if (doc.getElementById("opc").value == "new")
                array.setObjeto('Perfiles_portal','guardar');
            else
                array.setObjeto('Perfiles_portal','actualizar');
  ...
  function validarSiNumero(numero){
    ...
    function editarPerfiles(id){
        array = new XArray();
        array.setObjeto('Perfiles_portal','editar');
    ...
    function eliminarPerfiles(id){
        if(confirm("¿Desea Eliminar el Perfiles Seleccionado?")){
            array = new XArray();
            array.setObjeto('Perfiles_portal','eliminar');
            array.addParametro('id',id);
            array.addParametro('permiso',document.getElementById('permiso_modulo').value);
            array.addParametro('import','clases.perfiles_portal.Perfiles_portal');
            xajax_Loading(array.getArray());
    ...
    function verPagina(pag,doc){
        ...
        array.setObjeto('Perfiles_portal','buscar');
        array.addParametro('import','clases.perfiles_portal.Perfiles_portal');
        $('#MustraCargando').show();
        xajax_Loading(array.getArray());
    }
