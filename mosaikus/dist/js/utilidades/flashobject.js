...
FlashObject = function(swf, id, w, h, ver, styl, transp) {
...
FlashObject.prototype.getHTML = function() {
    ...
    if (window.ActiveXObject && navigator.userAgent.indexOf('Mac') == -1) { // PC IE
        ...
        flashHTML += '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="' + this.width + '" height="' + this.height + '" id="' + this.id + '" align="' + this.align + '" style="' + this.style + '">';
        ...
        flashHTML += '<embed type="application/x-shockwave-flash" src="' + this.swf + '" width="' + this.width + '" height="' + this.height + '" id="' + this.id + '" align="' + this.align + '" wmode="' + this.transparency + '"';
